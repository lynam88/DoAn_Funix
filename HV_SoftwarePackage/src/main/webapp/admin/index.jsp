          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold" style="font-size: 14px !important;">Tổng Tiền Quyên Góp</p>
                    <h5 class="font-weight-bolder" style="font-size: 20px;">
                      53.000.000.000Đ
                    </h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold" style="font-size: 13px !important;">Người Dùng Hôm Nay</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Quyên Góp Hôm Nay</p>
                    <h5 class="font-weight-bolder">
                      3.000.000Đ
                    </h5>
                    <p class="mb-0">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Đang Diễn Ra</p>
                    <h5 class="font-weight-bolder">
                      13 Đợt
                    </h5>
                    <p class="mb-0">
                      <span class="text-success text-sm font-weight-bolder">+5%</span> so với tháng rồi
                    </p>
                  </div>
                </div>
                <div class="col-4 text-end">
