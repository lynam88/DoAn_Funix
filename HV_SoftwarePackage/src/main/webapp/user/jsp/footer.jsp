          ...
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">                
 				<a class="blog-img mr-4" href="${pageContext.request.contextPath}/UsersDonationController?action=donationPost&id=${donation.id}" style="background-image: url(${donation.src});"></a>
                <div class="text">
                  <h3 class="heading"><a href="${pageContext.request.contextPath}/UsersDonationController?action=donationPost&id=${donation.id}">${donation.title} </a></h3>
                  <div class="meta">
