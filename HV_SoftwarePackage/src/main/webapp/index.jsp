      ...
      <ul class="navbar-nav">
        <li class="nav-item mt-3">
	        <a class="nav-link active" href="./pages/dashboard.html">
	          <h6 class="text-uppercase text-xs font-weight-bolder opacity-6">Trang chủ</h6>
	        </a>
        </li>
        <li class="nav-item">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Tổng Tiền Quyên Góp</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Người Dùng Hôm Nay</p>
                    <h5 class="font-weight-bolder">
                      100
                    </h5>
                    <p class="mb-0">
