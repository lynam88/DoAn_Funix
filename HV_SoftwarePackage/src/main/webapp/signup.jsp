						...
						<form action="UsersController?action=signup" method="post" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6">
									<div class="card-body p-md-5 mx-md-4">
										<h6 style="color: blue; display: inline-block;">ĐĂNG KÝ THÀNH VIÊN MỚI</h6>									
										...
										<div class="form-outline my-3">
											...
											<div class="input-group">
												...
												<input type="text" id="address" name="address"
													class="form-control" placeholder="Xin nhập địa chỉ" value="${inputUser.address}">
											</div>
							...
							<div class="row justify-content-center mt-4" style="margin-top: -1.5rem!important;">
								<div class="col-lg-6" style="text-align: center!important;">
									<input type="radio" id="agree" name="agree" value="yes"
										onclick="enableButton()"/> <label for="agree" >Tôi đã đọc và đồng ý với các quy định của trang web</label>
								</div>
							</div>
							...
							<div class="col text-center">
							  <div style="display: flow-root; padding-bottom: 2%;">
							    <span class="text-center">Bạn đã có tài khoản? </span>
							    <a href="#" id="login" style="color: aquamarine;">Xin Đăng Nhập!</a>
							  </div>
							</div>
						</form>									
					</div>					
