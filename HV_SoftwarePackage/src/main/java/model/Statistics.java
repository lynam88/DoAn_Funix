...
public class Statistics {	
	private String name, email, avatarPath, posts, status, title, category, src, userDonationStatus;
	private int totalUsers, totalDonations, dayDiff, donationId;
	private Float donationAmount, totalDonationAmount, todayDonationAmount, totalNeeded;
	private Date startDate, endDate, insertDate, donationDate;
